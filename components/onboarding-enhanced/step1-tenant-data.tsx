...
interface Step1Props {
  tenant?: Tenant
  adminUser?: AdminUser
  onNext: (data: { tenant: Tenant; adminUser: AdminUser }) => void
  saving?: boolean
}
...
export default function Step1TenantData({ tenant, adminUser, onNext, saving = false }: Step1Props) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!tenantData.address?.neighborhood?.trim()) newErrors.neighborhood = "Bairro é obrigatório"
    if (!tenantData.address?.state?.trim()) newErrors.state = "Estado é obrigatório"
    if (!tenantData.address?.city?.trim()) newErrors.city = "Cidade é obrigatória"
    if (!tenantData.address?.postal_code || !validateCEP(tenantData.address.postal_code)) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              ...
              <Input
                ...
                onChange={(e) => handleTenantChange("address.street", e.target.value)}
            ...
            <div>
              ...
              <Input
                value={tenantData.address?.number || ""}
                onChange={(e) => handleTenantChange("address.number", e.target.value)}
                placeholder="123"
            ...
            <div>
              ...
              <Input
                value={tenantData.address?.neighborhood || ""}
                onChange={(e) => handleTenantChange("address.neighborhood", e.target.value)}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleTenantChange("address.city", e.target.value)}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleTenantChange("address.state", e.target.value)}
                placeholder="SP"
                maxLength={2}
            ...
            <div>
              ...
              <Input
                value={tenantData.address?.postal_code || ""}
                onChange={(e) => handleTenantChange("address.postal_code", formatCEP(e.target.value))}
            ...
            <div className="md:col-span-3">
              ...
              <Input
                value={tenantData.address?.complement || ""}
                onChange={(e) => handleTenantChange("address.complement", e.target.value)}
