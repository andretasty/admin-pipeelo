...
export default function Step7ReviewDeploy({ 
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="card-subtle">
        <CardHeader>
          <CardTitle className="text-lg" style={{ color: "#2D3748" }}>
        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              <div className="label-small">URL de Produção</div>
              <div className="text-base font-medium value-accent">
                {deploymentUrl}
              </div>
            </div>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-blue-800 text-sm">
                <strong>Importante:</strong> Após o deploy, o sistema será automaticamente configurado e estará disponível na URL acima. 
                Você receberá um email de confirmação com os detalhes de acesso.
              </p>
            </div>
          </div>
        </CardContent>
